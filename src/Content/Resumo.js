...
import './ContentStyling/Resumo.css';


function Resumo(){

    // State for Resumo Expand
    const [expand, setExpand] = React.useState(true)
    
    const resumoCollapsedText = (
        <p>
    ...
    // State for Resumo Text
    const [resumoText, setResumoText] = React.useState(resumoCollapsedText)

    function expandcollapse(){
        // expanding resumo 
        if (expand == true){
            setResumoText(() => resumoExpandedText);
        } 
        // collapsing resumo
        else{
            setResumoText(() => resumoCollapsedText);
        }
